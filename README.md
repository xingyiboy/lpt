...
本项目集合包含多个独立项目，每个项目都针对不同的业务场景和技术需求。从微服务架构到单体应用，从前端项目到后端服务，提供了完整的企业级多因子登录验证解决方案。包含字符校验，数字计算校验， 邮箱校验，行为校验，人脸校验。可以通过请求接入到接口平台实现高效的校验切换，登录计算风险因子，通过因子的比例判断高风险，中风险，低风险，提供不同的验证方式。
